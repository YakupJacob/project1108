...
//      Get the String array as $115  $23 , $75  remove the $ and sum the numbers
            ...
            String[][] strarr4 = {{"USA" , "Mexico"} , {"South Korea" ,"Russia" , "China"} , {"India","Pakistan"}};

            for(int i = strarr4.length-1 ; i>=0 ; i--){

                for(int j = strarr4[i].length-1 ;j>=0; j--){

                    char[] strarr3Chars = strarr4[i][j].toCharArray();
        ...
        public static void olur(String[] args) {
